    ...
    inputSchema: {
      ...
      properties: {
        intent: {
          type: 'string',
          description:
            'Natural-language interaction intent (e.g., "click submit button", "search products", "confirm checkout", "fill form field"). When looking for a specific control or action, provide this parameter to semantically retrieve and rank matching candidates with refs instead of fetching the full page tree.',
        },
        maxCandidates: {
          type: 'number',
          description:
    ...
    inputSchema: {
      ...
      properties: {
        intent: {
          type: 'string',
          description:
            'Natural-language interaction intent describing the target action or element (e.g., "click submit button", "search products", "confirm checkout", "fill form field").',
        },
        maxCandidates: {
          type: 'number',
          description:
